          ...
          >
            ...
            <div className="relative z-10 flex flex-col xl:flex-row gap-12">
              ...
              <div className="flex-1 space-y-8">
                <div>
                  <div className="flex items-center gap-4 mb-4 text-white/50 text-sm font-mono tracking-widest uppercase">
                    <span className="flex items-center gap-2"><Calendar className="w-4 h-4" /> 2025</span>
                    <span className="flex items-center gap-2"><MapPin className="w-4 h-4" /> IIT Mandi</span>
                  </div>

                  {/* No Logo Placeholder - just title */}
                  <div className="mb-6 flex items-center gap-4">
                    <h4 className="text-3xl md:text-4xl font-medium text-white">
                      IMDB Rating Analyser
                    </h4>
                  </div>

                  <p className="text-white/70 font-light leading-relaxed text-lg mb-8 max-w-2xl">
                    Built a sentiment analysis system that predicts whether a movie is good, neutral, or bad based on user-written reviews. The model studies the text written by viewers and classifies the sentiment to help audiences and filmmakers quickly gauge public reactions.
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full min-h-[300px]">
                  ...
                  <div className="rounded-2xl bg-white/5 border border-white/10 flex flex-col items-center justify-center text-white/30 hover:bg-white/10 transition-colors group overflow-hidden relative">
                    <ImageIcon className="w-8 h-8 mb-2 group-hover:scale-110 transition-transform" />
                    <span className="text-sm font-medium tracking-wide">Event Photo 1</span>
                    <img src="/assets/IMG_4294.JPG" alt="IIT Mandi Event" className="absolute inset-0 w-full h-full object-cover" />
                  </div>

                  {/* Image 2 */}
                  <div className="rounded-2xl bg-white/5 border border-white/10 flex flex-col items-center justify-center text-white/30 hover:bg-white/10 transition-colors group overflow-hidden relative">
                    <ImageIcon className="w-8 h-8 mb-2 group-hover:scale-110 transition-transform" />
                    <span className="text-sm font-medium tracking-wide">Project Presentation</span>
                    <img src="/assets/IMG_1294.PNG" alt="Project Presentation" className="absolute inset-0 w-full h-full object-cover" />
                  </div>
                </div>
              </div>
